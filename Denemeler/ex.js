var html = document.getElementById("cat1")

document.getElementById("soru").innerHTML = `[3, 6, 2, 5, 8, 9, 1]`
document.getElementById("soru").style.color = "red"
...
document.getElementById("element").append(s)
console.log("----------------------------------------");
...
document.getElementById("element").append(as)
console.log(`indexs: ${as}`);
console.log("----------------------------------------");
